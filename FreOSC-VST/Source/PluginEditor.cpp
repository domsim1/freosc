...
//==============================================================================
// FL Studio 3x Osc inspired theme - grey metallic look
const juce::Colour FreOscEditor::backgroundColour = juce::Colour(0xff5a6268);  // Main grey background
const juce::Colour FreOscEditor::panelColour = juce::Colour(0xff6c757d);       // Lighter panel grey
const juce::Colour FreOscEditor::accentColour = juce::Colour(0xffff9500);      // Orange accent like FL
const juce::Colour FreOscEditor::textColour = juce::Colour(0xff2c3e50);        // Dark text on grey
const juce::Colour FreOscEditor::knobColour = juce::Colour(0xff4a5568);        // Darker grey for controls
    ...
    : AudioProcessorEditor (&p), audioProcessor (p), tabbedComponent(juce::TabbedButtonBar::TabsAtTop)
{
    ...
    titleLabel.setText("FreOSC Synthesizer", juce::dontSendNotification);
...
{
    // FL Studio 3x Osc style metallic gradient background
    auto bounds = getLocalBounds();
    
    // Create metallic gradient from lighter to darker grey
    juce::ColourGradient gradient(
        juce::Colour(0xff6c757d),  // Lighter grey at top
        0, 0, 
        juce::Colour(0xff4a5568),  // Darker grey at bottom
    ...
    // Add subtle metallic shine highlight at the top
    juce::ColourGradient shine(
        juce::Colour(0xff8a9ba8).withAlpha(0.3f),  // Light highlight
        0, 0,
    ...
    g.fillRect(bounds.removeFromTop(40));
}
...
void FreOscEditor::setupComponent(juce::Component& component)
{
    ...
    else if (auto* slider = dynamic_cast<juce::Slider*>(&component))
    {
        ...
        slider->setColour(juce::Slider::thumbColourId, juce::Colour(0xffd4d4d4)); // Light grey thumb
    ...
    else if (auto* group = dynamic_cast<juce::GroupComponent*>(&component))
    {
        ...
        // Note: GroupComponent doesn't have backgroundColourId in newer JUCE versions
        // group->setColour(juce::GroupComponent::backgroundColourId, backgroundColour.withAlpha(0.3f));
    }
}
                              ...
                              const juce::String& labelText, const juce::String& parameterID)
{
    ...
    valueLabel.setColour(juce::Label::textColourId, accentColour.darker(0.2f)); // Orange tint like FL
...
void FreOscEditor::layoutFMSection()
{
    ...
    // Source
    row = bounds.removeFromTop(rowHeight);
    fmSourceLabel.setBounds(row.removeFromLeft(60));
    fmSourceCombo.setBounds(row);
...
void FreOscEditor::setupComboBoxOptions()
{
    ...
    // FM source options
    fmSourceCombo.addItem("None", 1);
    fmSourceCombo.addItem("Oscillator 1", 2);
    fmSourceCombo.addItem("Oscillator 2", 3);
    fmSourceCombo.addItem("Oscillator 3", 4);
    
    // FM target options
    fmTargetCombo.addItem("Oscillator 1", 1);
    fmTargetCombo.addItem("Oscillator 2", 2);
    fmTargetCombo.addItem("Oscillator 3", 3);
    fmTargetCombo.addItem("All Oscillators", 4);
...
void FreOscEditor::createParameterAttachments()
{
    ...
    comboAttachments.push_back(std::make_unique<juce::AudioProcessorValueTreeState::ComboBoxAttachment>(valueTreeState, "fm_source", fmSourceCombo));
...
void FreOscEditor::createTabbedInterface()
{
    ...
    // Style the tab buttons to look metallic like FL Studio
    auto& tabBar = tabbedComponent.getTabbedButtonBar();
    tabBar.setColour(juce::TabbedButtonBar::tabOutlineColourId, knobColour);
    tabBar.setColour(juce::TabbedButtonBar::tabTextColourId, textColour);
    tabBar.setColour(juce::TabbedButtonBar::frontOutlineColourId, accentColour);
    tabBar.setColour(juce::TabbedButtonBar::frontTextColourId, textColour);
...
std::unique_ptr<juce::Component> FreOscEditor::createOscillatorsTab()
{
    ...
    public:
        ...
        void setupDirectOscillator(FreOscEditor::OscillatorSection& section, const juce::String& title, [[maybe_unused]] const juce::String& paramPrefix)
        {
            ...
            section.levelValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
            ...
            section.detuneValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
            ...
            section.panValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
        ...
        void setupDirectNoise()
        {
            ...
            owner.noiseLevelValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
            ...
            owner.noisePanValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
        ...
        void paint(juce::Graphics& g) override
        {
            ...
            // Draw oscillator borders with titles
...
std::unique_ptr<juce::Component> FreOscEditor::createFilterEnvelopeTab()
{
    ...
    public:
        ...
        void setupDirectFilter()
        {
            ...
            owner.cutoffValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
            ...
            owner.resonanceValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
            ...
            owner.filterGainValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
        ...
        void setupDirectEnvelope()
        {
            ...
            owner.attackValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
            ...
            owner.decayValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
            ...
            owner.sustainValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
            ...
            owner.releaseValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
        ...
        void paint(juce::Graphics& g) override
        {
            ...
            // Draw envelope border with title
...
std::unique_ptr<juce::Component> FreOscEditor::createModulationTab()
{
    ...
    public:
        ...
        void setupDirectLFO()
        {
            ...
            owner.lfoRateValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
            ...
            owner.lfoAmountValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
        ...
        void setupDirectFM()
        {
            ...
            // Setup components with proper styling
            owner.applyComponentStyling(owner.fmSourceCombo);
            ...
            owner.applyComponentStyling(owner.fmSourceLabel);
            ...
            owner.fmAmountValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
            ...
            owner.fmRatioValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
            ...
            // Set labels
            owner.fmSourceLabel.setText("Source:", juce::dontSendNotification);
            ...
            // Add ALL components directly to the tab (not to a group) - INCLUDING VALUE LABELS
            addAndMakeVisible(owner.fmSourceLabel);
            addAndMakeVisible(owner.fmSourceCombo);
        ...
        void layoutDirectFM(juce::Rectangle<int> area)
        {
            ...
            // Layout: Source and Target dropdowns on top, then Amount and Ratio knobs
            auto topRow = area.removeFromTop(50).reduced(5);
            
            // Source dropdown (left half)
            auto sourceArea = topRow.removeFromLeft(topRow.getWidth() / 2).reduced(2);
            owner.fmSourceLabel.setBounds(sourceArea.removeFromTop(15));
            owner.fmSourceCombo.setBounds(sourceArea);
...
std::unique_ptr<juce::Component> FreOscEditor::createEffectsTab()
{
    ...
    public:
        ...
        void setupDirectReverb()
        {
            ...
            owner.roomSizeValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
            ...
            owner.reverbWetValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
        ...
        void setupDirectDelay()
        {
            ...
            owner.delayTimeValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
            ...
            owner.delayFeedbackValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
            ...
            owner.delayWetValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
...
std::unique_ptr<juce::Component> FreOscEditor::createMasterTab()
{
    ...
    public:
        ...
        void setupDirectMaster()
        {
            ...
            owner.masterVolumeValue.setColour(juce::Label::textColourId, owner.accentColour.darker(0.2f));
                                     ...
                                     const juce::String& labelText, const juce::String& parameterID)
{
    ...
    valueLabel.setFont(juce::Font(juce::FontOptions().withHeight(11.0f * currentScale)));
    valueLabel.setJustificationType(juce::Justification::centred);
    valueLabel.setColour(juce::Label::textColourId, accentColour.darker(0.2f));
    valueLabel.setColour(juce::Label::backgroundColourId, juce::Colours::transparentBlack);
